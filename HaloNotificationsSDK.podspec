Pod::Spec.new do |spec|
  ...
  spec.source           = { :http => 'https://github.com/mobgen/halo-notifications-ios/archive/2.3.1.zip' }

  spec.platforms        = { :ios => '8.0' }
  spec.requires_arc     = true
  spec.ios.framework    = 'UserNotifications'
  spec.ios.vendored_frameworks = 'halo-notifications-ios-2.3.1/Frameworks/Firebase/**/*.framework'
  spec.ios.vendored_libraries = 

  spec.source_files     = 'halo-notifications-ios-2.3.1/Source/**/*.swift'
  spec.resources        = ['halo-notifications-ios-2.3.1/Sounds/*'] 
